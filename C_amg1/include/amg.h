...
/* Smoother types */
#define SMOOTHER_L1      0  /* l1-Jacobi: D_l1 = diag(|A|*1) (default) */
#define SMOOTHER_GS      1  /* lexicographic Gauss-Seidel */
#define SMOOTHER_CF_GS   2  /* CF-ordered Gauss-Seidel */
#define SMOOTHER_JACOBI  3  /* damped Jacobi */

/* Coarsening types */
#define COARSEN_RS   0  /* classical Ruge-Stuben (default) */
#define COARSEN_PMIS 1  /* Parallel Modified Independent Set */
#define COARSEN_HMIS 2  /* Hybrid Modified Independent Set */
...
typedef struct {
  ...
  INT  smoother;     /* smoother type (SMOOTHER_L1 default) */
  REAL omega_jacobi; /* Jacobi damping factor (default 0.5) */
  INT  coarsening;   /* coarsening type (COARSEN_RS default) */
} amg_data;
